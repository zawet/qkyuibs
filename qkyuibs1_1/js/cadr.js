...
define(function(require) {
	...
	var thishtml='<div class="col-sm-6"><table class="table table-bordered table_card"><tbody><tr><td colspan="2" class="col-xs-10"><h4 class="mt0 mb0">';
	var thishtml2='</h4></td><td rowspan="3" class="col-xs-2 td_mc"><a class="edit"><i class="qkyicon_14 mr5">&#xe60f;</i>编辑</a></td></tr><tr><td>值班人员：</td><td>';
	var thishtml3='</td></tr><tr><td>记录人：</td><td>';
